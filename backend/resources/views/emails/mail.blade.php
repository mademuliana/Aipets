                            ...
                            <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                                ...
                                <tr>
                                    <td align="center" height="70" style="height:70px;">
                                        <a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="100" border="0" style="display: block; width: 100px;" src="https://i.ibb.co/h9YxD8S/ezgif-3-3ec71b3e330e-removebg-preview.png" alt="" /></a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;"
                            ...
                            <div style="line-height: 35px">
                                ...
                                Undangan Bergabung Bersama Kami <span style="color: #5caad2;">Aipet.id</span>
                            ...
                            <table border="0" width="590" align="center" cellpadding="0" cellspacing="0" class="container590">
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        <p style="line-height: 24px;margin-bottom:15px;">
                                            Selamat!, kamu telah menerima undangan untuk menjadi salah satu pemilik hewan dari aipet.id. segera daftarkan dirimu dan bergabung bersama kami di Aipet.id
                                        </p>
                                        <p style="line-height: 24px; margin-bottom:20px;">
                                            Kamu dapat melakukan registrasi dengan menekan tombol dibawah ini
                                        </p>
                                            ...
                                            <tr>
                                                <td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">
                                                    ...
                                                    <div style="line-height: 22px;">
                                                        <a href="{{$data['link'] }}" style="color: #ffffff; text-decoration: none;">Link Registrasi</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        ...
                                        <p style="line-height: 24px; margin-bottom:20px;">
                                            Jika tombol diatas tidak bekerja kamu dapat menuju link ini untuk melanjutkan registrasi akun kamu : {{$data['link'] }}
                                        </p>
                                    ...
                                    <td>
                                        <table border="0" width="300" align="left" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"
                                            ...
                                            <tr>
                                                <!-- logo -->
                                                <td align="left">
                                                    <a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="80" border="0" style="display: block; width: 80px;" src="https://i.ibb.co/h9YxD8S/ezgif-3-3ec71b3e330e-removebg-preview.png" alt="" /></a>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="left" style="color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;"
                                                    ...
                                                    <div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
                                                        ...
                                                        Email us: <br/> <a href="mailto:" style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">Aipetscare@gmail.com</a>
